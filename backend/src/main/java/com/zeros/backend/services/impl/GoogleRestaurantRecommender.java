...
@Service
public class GoogleRestaurantRecommender implements RestaurantRecommender {

    private final GeoApiContext geoApiContext;
    private final RouteEstimator routeService;

    @Autowired
    public GoogleRestaurantRecommender(GeoApiContext geoApiContext, RouteEstimator routeestimator) {
